...
export function createMockChatService(overrides: Partial<ChatService> = {}): Partial<ChatService> {
  const mockService = {
    initialize: async () => {},
    processMessage: async (threadId: string, content: string): Promise<string> => {
