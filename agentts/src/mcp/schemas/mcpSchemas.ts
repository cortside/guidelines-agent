...
export const MCPToolSchema = Type.Object({
  ...
  description: Type.String({
    ...
    examples: ['Get comprehensive information about REST API features and expected standards']
  }),
  inputSchema: Type.Optional(Type.Object({}, {
...
export const MCPServerCapabilitiesSchema = Type.Object({
  ...
  prompts: Type.Optional(Type.Object({}, {
