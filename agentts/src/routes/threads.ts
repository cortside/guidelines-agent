...
const threadRoutes: FastifyPluginAsyncTypebox = async function (fastify) {
  ...
  fastify.get(
    "/threads/stats",
    {
      schema: {
        description:
          "Retrieves debugging information about thread storage and analytics",
  ...
  fastify.get(
    "/threads",
    {
      schema: {
        description:
          "Retrieves a list of all conversation threads with metadata",
  ...
  fastify.post(
    "/threads",
    {
      schema: {
        description:
          "Creates a new conversation thread with optional name and metadata",
